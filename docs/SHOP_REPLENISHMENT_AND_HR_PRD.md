...
| 文件版本 | 2.1 |
| 文件日期 | 2026-09-03 |
| 文件狀態 | Phase 1 規則已齊。Phase 2 Shop HR 以舊 FC Shop App 選單為參考；疫苗接種記錄不做。內頁欄位待截圖。 |
...
疫苗接種記錄、自動出糧、IR56 電子申報、MPF 電子申報、未授權跨店調班、用假期類別頁冒充請假。HR 不阻擋 Phase 1 訂貨。
...
2. Phase 2 HR 另開 change；先收齊 §12.0 要的內頁截圖再定欄位。
