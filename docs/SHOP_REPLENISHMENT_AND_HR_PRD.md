...
| 文件版本 | 2.4 |
| 文件日期 | 2026-09-03 |
| 文件狀態 | Phase 1 規則已齊。應徵、員工、本月打卡入口已對截圖；打卡「有紀錄的一天」與怎樣打卡仍待補。疫苗接種記錄不做。 |
...
| 守則及告示 | 新 | 無 | **要** 列表＋一篇內容 |
| 員工生日日曆 | 依員工「生日日期」 | 詳情已有月日 | 有獨立日曆頁才要；沒有可用員工生日做月曆 |
| 升職及加薪記錄 | 新 | 無 | **要** 列表＋一筆 |
| 疫苗接種記錄 | **不做** | — | **不用** |
...
要做。手記／匯入，不做法定計算或申報。舊 App 員工詳情只見 **MPF 交表日期**；按月僱員／僱主供款若在報稅或其他頁，等截圖再補欄。
...
| 編號 | 需求 |
| --- | --- |
| HR-15 | 網頁打上班／下班。打卡動作頁舊 App 未見，待截圖；沒有則做餐廳版面上下班鈕，寫入該店該組當日。 |
| HR-16 | 不接考勤機、不強制定位。 |
| HR-17 | 主管可補打卡（要原因與審計）。 |
...
9. MPF：舊 App 員工檔只有交表日期。按月供款是否在報稅頁？
10. 打卡：請補「有紀錄的一天」（誰、上／下班）以及同事怎樣打卡。樓面是否算在「報數」組。

## 17. 建議下一步

1. 以本 PRD 開 OpenSpec change `add-shop-replenishment`（餐廳版面＋雙通道訂貨＋貨倉入出）。
2. Phase 2 HR 另開 change。應徵（§12.7）、員工（§12.1）已定；打卡入口已定（§12.5），仍欠有紀錄的一天與打卡動作。其餘先收齊 §12.0 內頁截圖。
