...
| 文件版本 | 2.8 |
| 文件日期 | 2026-09-03 |
| 文件狀態 | Phase 1 規則已齊。主頁、應徵、員工、打卡入口、生日日曆已對截圖。**不做疫苗接種記錄、守則及告示、不獲聘用名單。** 打卡明細、新增活動與其餘 HR 內頁仍待補。 |
...
| Shop HR | 獨立角色；Phase 2。選單對齊舊 FC Shop App。**不做疫苗接種記錄、守則及告示、不獲聘用名單。** 打卡先做網頁。MPF 要做（手記）。常用聯絡人≠供應商電話簿。 |
