...
| 文件版本 | 2.7 |
| 文件日期 | 2026-09-03 |
| 文件狀態 | Phase 1 規則已齊。主頁、應徵、員工、打卡入口、生日日曆已對截圖。**不做疫苗接種記錄、守則及告示。** 打卡明細、新增活動與其餘 HR 內頁仍待補。 |
...
| Shop HR | 獨立角色；Phase 2。選單對齊舊 FC Shop App。**不做疫苗接種記錄、守則及告示。** 打卡先做網頁。MPF 要做（手記）。常用聯絡人≠供應商電話簿。 |
...
6. Phase 2 在餐廳版面補 Shop Manager／Shop HR。選單對齊舊 FC Shop App（見 §12）；疫苗接種記錄、守則及告示不做。
...
Shop Manager／獨立 Shop HR。選單對齊舊 FC Shop App（應徵、員工、打卡、生日、升職加薪、常用聯絡人、不獲聘、報稅）。**不做疫苗接種記錄、守則及告示。** 舖頭報數＝Phase 1 每日銷售。假期／更表／MPF 仍列需求，入口待截圖確認。
...
疫苗接種記錄（含舊入職表「疫苗記錄(針)」）、守則及告示、自動出糧、IR56 電子申報、MPF 電子申報、未授權跨店調班、用假期類別頁冒充請假。HR 不阻擋 Phase 1 訂貨。
