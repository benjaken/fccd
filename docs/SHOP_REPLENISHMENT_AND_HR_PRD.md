...
| 文件版本 | 1.3 |
| 文件日期 | 2026-09-03 |
| 文件狀態 | 已收錄餐廳訂貨二級頁、雙通道訂貨、餐廳版面與貨倉入／出貨；可進入 OpenSpec／實作規劃 |
| 所屬模塊 | 餐廳版面、餐廳訂貨、凍貨、乾貨、工場貨倉、人力資源 |
| 主要使用者 | 餐廳同事／Shop Manager、寫字樓審核、工場、Shop HR、Accounting、Admin／Super Admin |
| 目標 | 旗下餐廳用獨立餐廳版面做每日營運與訂貨；外部供應商產生 WhatsApp，自己倉在 FCCD 登記後經寫字樓修改或傳送工場；工場貨倉可入貨與出貨。後續再補 Shop HR。 |
| 參考 | `docs/API_FUNCTIONAL_PRD.md` §5.8 TRF、§5.11 ROS；`docs/SITEMAP.md`；`docs/architecture/functional-catalog.md`；`docs/PERMISSION_SITEMAP.md` |
...
| 訂貨雙通道 | **外部供應商**→產生 WhatsApp；**自己倉**→在 FCCD 登記成表格，走審核／工場。 |
| 審核 | 寫字樓審核；可**修改**申請，或**傳送工場**。店長不可批。 |
| 傳工場 | 先處理／修改，再**手動**傳送工場；不會自動發送。 |
| 截單 | 沒有每日截單。下單必填送貨日期。 |
| 價格 | 舖頭訂貨不顯示成本或轉撥價。 |
| 出貨 | 自己倉申請一次出完。 |
| 目錄 | 自己倉用現有凍貨／`ingredients` 加「分店可訂」。外部供應商用該供應商分類下的可訂品項。 |
...
1. **外部供應商**：店舖直接向外面供應商叫貨，需要電話／WhatsApp，不是工場執貨。
2. **自己倉（FCCD 中央倉）**：向荃灣凍房／乾貨倉要貨，必須在系統登記，寫字樓改完或核准後才傳工場，工場做出貨，並留下入／出貨紀錄。

現行缺口：沒有餐廳專用工作區、沒有「餐廳訂貨」二級頁、沒有 WhatsApp 叫貨、沒有自己倉待審→傳工場、乾貨沒有出入倉流水。每日銷售等營運頁已在主系統 `/restaurant/*`，但餐廳同事不應和到會訂單工作區混在一起。

## 2. 產品目標

1. 餐廳同事進入**餐廳版面**，做每日銷售等現有輸入，以及舖頭訂貨。
2. 寫字樓在主系統「餐廳訂貨」下管理供應商分類、電話簿、訂貨需求、訂貨紀錄與審核。
3. 外部供應商需求一鍵產生 WhatsApp 訊息（帶電話簿號碼）。
4. 自己倉需求在 FCCD 登記成表格，寫字樓可修改，或傳送工場。
5. 工場貨倉看到已傳送的自己倉單，可入貨、出貨；不足警示仍可出。
...
| 訂貨分類 | 供應商列表上的分類：至少「外部供應商」與「自己倉」。一間供應商只屬一種通道。 |
| 自己倉 | FCCD 中央凍房／乾貨倉，不是外面供應商。 |
| 訂貨需求 | 店舖提出的要貨單。外部＝待發 WhatsApp；自己倉＝在 FCCD 登記的表格。 |
| 舖頭訂貨 | 餐廳版面建立訂貨需求的頁。 |
| 訂單審核 | 寫字樓改自己倉單，或傳送工場。 |
| 供應商電話簿 | 外部供應商聯絡人與電話，供 WhatsApp。 |
| 入貨紀錄 | 貨倉收貨入 FCCD 自己倉。 |
| 出貨紀錄 | 貨倉發給分店；一張自己倉申請一次出完。 |
...
2. 選該分類可訂品項、數量、送貨日期、備註。不顯示價格。
3. 「產生 WhatsApp」：用電話簿號碼開 `wa.me`／WhatsApp，預填店名、送貨日期、品項與數量。
4. 系統把該需求記進訂貨紀錄（狀態如 `whatsapp_created`）。**不自動傳 WATI、不傳工場、不扣自己倉。**
5. 實際付款／入帳仍用現有每日採購，不把 WhatsApp 當會計憑證。

### 7.2 自己倉 → FCCD 登記

1. 選「自己倉」分類（或等同 FCCD 倉供應商）。
2. 只可選「分店可訂」凍貨／乾貨；可混在同一張表。
...
| --- | --- |
| 店舖 | 鎖定本店（將軍澳） |
| 訂貨分類／供應商 | 必填，決定 WhatsApp 或自己倉 |
| 送貨日期 | 必填；不可早於今天；無截單 |
| 明細 | 至少一行；品項受該供應商／自己倉目錄限制 |
| 價格 | 不顯示 |

外部：產生 WhatsApp。自己倉：保存並送出登記。

### 8.3 供應商列表（訂貨分類）

寫字樓維護：名稱、分類（外部／自己倉）、啟用、可訂品項、排序。自己倉必須能掛現有凍貨／`ingredients` 的「分店可訂」。外部可掛該供應商品項（可先用 `restaurant_ingredients` 或簡表，實作時選定一處，不要第三套主檔）。

### 8.4 供應商電話簿

聯絡人、電話、所屬供應商、備註。一個供應商可多個號碼；產生 WhatsApp 時可選。沒有電話則不能產生。

### 8.5 訂貨需求（寫字樓）

全店佇列：通道、供應商、店舖、送貨日期、狀態。自己倉可點進審核；外部可看已產生的 WhatsApp 內容與重開連結。
...
只處理自己倉。可修改（行、量、備註）或傳送工場。修改要留審計。傳送後店舖不可再改量。拒絕要原因。

### 8.8 工場貨倉存貨

**入貨紀錄：** 品項、數量、單位、日期、供應商／來源、批次（可空）、操作者。寫入自己倉流水（凍貨走現有 movement；乾貨新建）。不可改寫盤點快照。

**出貨紀錄：** 對已傳送的自己倉單執貨。實發 ≤ 核准。不足／未盤點警示仍可出。一單一次出完。出貨後在途，待分店收貨。
...
| ORD-01 | 舖頭可建訂貨需求，必填送貨日期，不顯示價格。 | P0 |
| ORD-02 | 外部供應商需求產生 WhatsApp（電話簿號碼＋預填內容），並寫入訂貨紀錄。 | P0 |
| ORD-03 | 自己倉需求在 FCCD 登記成表格，進入訂貨需求／訂單審核。 | P0 |
| ORD-04 | 寫字樓供應商列表以訂貨分類區分外部／自己倉，並維護可訂品項。 | P0 |
| ORD-05 | 寫字樓供應商電話簿；無電話不可產生 WhatsApp。 | P0 |
...
| 供應商可訂品項 | 外部→供應商品項；自己倉→凍貨／`ingredients`＋`shop_orderable` |
...
WhatsApp 只存產生時間、號碼、訊息快照、開啟結果（若可知）；不把 WhatsApp 當已入帳。

編號：自己倉 `SR-YYYYMMDD-####`；外部可用 `WX-YYYYMMDD-####`，與到會訂單分開。

### 10.1 乾貨現況

`ingredients` 可作自己倉乾貨目錄（加分店可訂）。`ingredient_stocktake_events`／`packing_stocktake_events` 只是盤點快照。`restaurant_ingredients` 是店舖對外採購名單，適合外部供應商通道，**不是**自己倉結餘。乾貨出入倉流水本期要新建。入／出貨都不准寫成假盤點。
...
| 雙通道 | 已確認 | 外部 WhatsApp；自己倉 FCCD 登記。 |
| 審核 | 已確認 | 寫字樓可改單或傳工場。 |
| 無截單／必填送貨日／不顯示價／一次出完 | 已確認 | 同 v1.2。 |
| 貨倉入＋出 | 已確認 | 工場貨倉兩邊都做。 |
| 警示可出 | 已確認 | 不足仍可出。 |
| WhatsApp 發送管道 | 假設 | 先 `wa.me` 預填；不強制 WATI。 |
...
5. WhatsApp 只打開對話，不在瀏覽器存供應商私人對話。
...
2. 外部供應商單產生 WhatsApp 並出現在訂貨紀錄；工場看不到該單。
3. 自己倉單在 FCCD 成表；寫字樓可修改；未傳工場前工場不可見。
...
3. 外部可訂品項先用 `restaurant_ingredients` 還是供應商列表自維簡表。
4. WhatsApp 是否只需 `wa.me`，還是之後要 WATI 範本。
