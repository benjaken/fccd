...
insert into ingredients(
  ...
  ('fc4cdae7-24b2-433f-8026-2133cc652d27','500ml 甜品杯','個','箱',100,0.96,96,false,true),
  ('55255419-1471-4b6b-ac80-9518c686dfd0','300ml 甜品杯','個','箱',20,0.85,17,false,true),
  ('dfe98feb-c67d-4df0-b53f-38062380eedb','酒精 (1小時)','個','箱',36,2.1111,76,false,true),
  ('b186e205-2a0c-4121-8f33-caea80d6e0d2','粟米片','包','箱',8,18,144,false,true),
  ('83a650ca-4ca8-4195-8562-a588c247dfd2','塑料湯桶 連蓋 2L','個','箱',200,5.26,1052,false,true);
