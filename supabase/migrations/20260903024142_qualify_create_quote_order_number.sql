-- RETURNS TABLE(id, order_number) exposes order_number as a PL/pgSQL variable.
-- Unqualified RETURNING order_number therefore raises 42702 and blocks quote
-- creation. Qualify the orders column so the insert can capture any trigger
-- rewrite of the number.
