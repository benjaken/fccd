-- The catering utensil stocktake is measured in individual place settings.
-- One generated six-person pack therefore consumes six settings.
...
comment on function private.catering_line_material_requirements(uuid) is
  'Canonical catering BOM; six-person utensil packs deduct six settings and lunch-box utensils retain their package conversion.';
