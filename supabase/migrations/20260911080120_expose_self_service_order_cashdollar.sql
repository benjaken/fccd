...
begin
  ...
  return jsonb_build_object(
    ...
    'deliveryTime', coalesce(v_order.delivery_time, v_order.ship_out_time),
    ...
    'shippingFee', coalesce(v_order.shipping_fee, 0),
    'discount', coalesce(v_order.discount_amount, 0),
    'cashdollarRedeemed', coalesce(v_order.cashdollar_redeemed, 0),
    'cashdollarPurchased', coalesce(v_order.cashdollar_purchased, 0),
    ...
    'shopifyStoreDomain', (select store.shop_domain from public.shopify_stores store where store.id = v_order.shopify_store_id),
    'lines', coalesce((
