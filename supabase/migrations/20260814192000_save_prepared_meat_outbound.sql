-- Save (create or update) a prepared-meat delivery note, including editable
-- customer contact fields and replacement of line items.
...
comment on function public.save_prepared_meat_outbound(
  ...
  'Creates or updates a prepared-meat delivery note, contact fields, lines, and stock movements.';
