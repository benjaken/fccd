-- Selling price cost calculation page under Frozen Goods.
...
begin
  select coalesce(
    ...
    (
      ...
      from public.app_pages
      where parent_page_key = 'frozen'
        and page_kind = 'subpage'
    ),
    46
  )
  into target_sort;
...
new_pages as (
  ...
  from public.app_pages
  where page_key in ('frozen', 'frozen.selling_price_cost')
)
