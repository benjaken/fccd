-- The develop internal test number is operator test traffic, not customer
-- conversations, so it must never appear in historical learning or its summary.
delete from public.customer_service_learning_import_messages
where phone_normalized in ('8613828747224', '13828747224');
...
begin
  ...
  return query
    ...
    where messages.phone_normalized not in ('8613828747224', '13828747224')
    group by 1
    order by 1 desc
