...
- `whatsapp-customer-service`: 定義客人經 WhatsApp 查單、蒐集到會意見並通知同事、搜 FAQ、危險問題轉真人，以及香港繁體禮貌口吻、拒答無關問題與防越權調用的行為邊界。
...
- 測試：webhook 驗簽與冪等、電話對單（零／一／多張）、意見寫入與內部通知、FAQ 搜尋、轉真人規則、殺開關、口吻／粗口、無關問題與越權／套提示拒答。
