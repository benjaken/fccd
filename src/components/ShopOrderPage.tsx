        ...
        <section className={`shop-order-builder${selectedSupplierKeys.length ? " has-suppliers" : ""}${supplierPickerOpen ? " is-picker-open" : ""}`} aria-labelledby="shop-order-builder-title">
          ...
          {!activeGroup ? (
            ...
            return <section className="shop-order-active-supplier">
              ...
              <label className="shop-order-local-search"><Search /><input type="search" value={itemSearch} onChange={(event) => setItemSearch(event.target.value)} placeholder={t("shopOrdering.searchWithinSupplierPlaceholder", { supplier: activeGroup.supplierName })} /></label>
