...
export const MIGRATION_STATUS = {
  ...
  readiness: [
    ...
    { key: "production", status: "ready" },
    { key: "meatInventory", status: "ready" },
    { key: "restaurant", status: "ready" },
    { key: "authFiles", status: "partial" },
  ...
  editorOnlyMappings: [
    ...
    },
    {
      ...
      targetTable: "historical archive",
